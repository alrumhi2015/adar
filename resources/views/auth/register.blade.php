...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('تسجيل المشرفين') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="full_name" class="col-md-4 col-form-label text-md-right">{{ __('الاسم الكامل') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('نوع المستخدم') }}</label>

                            <div class="col-md-6">
                                <select name="user_type" required   class="form-control">
                                    <option value="m-manager">مشرف</option>
                                    <option value="f-manager">مشرفة</option>
                                  </select>
